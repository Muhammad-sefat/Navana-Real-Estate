...
const UserProfile = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Navana Group | User Profile</title>
      </Helmet>
      <div className="p-8 sm:flex justify-center w-full md:h-[75vh] items-center sm:space-x-6 dark:bg-gray-50 dark:text-gray-800 border border-[#00CC00] text-center rounded-md">
